"""
    This is an example script showing how to create an alert push destination rule, tests it and create an alert rule with the push destination. 
    The endpoints used are /api/v2/alert_push_destinations, /api/v2/test_alert_push_destinations and /api/v2/alert_rules.
...
body = {
    "endpoint": {"url": ""},#Paste your server URL here
    "authentication": {"secret": ""},#Paste your server secret here
    "name": "ExampleName"
}
...
body = {
  "schedule": "daily",
  "associated_accounts": [],#An associated_account or associated_group must be specified for the alert to take effect.
  "associated_groups": [],
  "filter_criteria": {
