...
Requirements:
    - NCM API v3 token set as NCM_API_TOKEN environment variable
      (Can be set in the API Keys tab of the Script Manager)
...
if not token:
    ...
    print("You can set it in the API Keys tab of the Script Manager")
    sys.exit(1)
