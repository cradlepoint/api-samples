...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog=\"\"\"Examples:
  python "Unregister Routers Batch.py" routers.csv
  python "Unregister Routers Batch.py" routers.csv --batch-size 50
  python "Unregister Routers Batch.py" routers.csv --batch-size 200 --delay 30
        \"\"\"
    )
