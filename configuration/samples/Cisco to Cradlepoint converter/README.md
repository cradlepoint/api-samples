...
1. **Object Group Not Found**
   - Ensure object groups are defined before being referenced in ACLs
   - Check for typos in object group names

2. **Invalid IP Addresses**
   - Verify IP address format (e.g., 192.168.1.1)
   - Check subnet mask format (e.g., 255.255.255.0)

3. **Missing Zone Assignments**
   - Ensure interfaces are assigned to zones
   - Check zone-pair configurations

### Debug Mode
Add debug output by modifying the script to include more verbose logging:
```python
...
3. Make your changes
4. Test with various Cisco configurations
...
### Version 1.0.0
- Initial release
- Support for basic ACLs and class maps
- Zone forwarding generation

### Version 1.1.0
- Added object group support
- Enhanced ACL parsing
- Improved zone mapping

### Version 1.2.0
- Added policy map support
- Added zone-pair support
